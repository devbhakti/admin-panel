...
const base_path = "c:/Users/admin/Downloads/DevBhakti-master/DevBhakti-master/devbhakti-frontend/src/locales/";

function update_json(file_path, lang_data, lang) {
    ...
    const common_updates = {
        "add": { en: "Add", hi: "जोड़ें", mr: "जोडा" }[lang],
        "add_paragraph": { en: "Add Paragraph", hi: "अनुच्छेद जोड़ें", mr: "परिच्छेद जोडा" }[lang],
        "add_step": { en: "Add Step", hi: "चरण जोड़ें", mr: "टप्पा जोडा" }[lang],
        "add_faq": { en: "Add Question", hi: "प्रश्न जोड़ें", mr: "प्रश्न जोडा" }[lang],
        "cancel": { en: "Cancel", hi: "रद्द करें", mr: "रद्द करा" }[lang],
        "processing": { en: "Processing...", hi: "प्रक्रिया में है...", mr: "प्रक्रिया सुरू आहे..." }[lang]
    };
    
    if (!data.common) data.common = {};
    
    for (const [k, v] of Object.entries(common_updates)) {
        if (!data.common[k]) {
            data.common[k] = v;
        }
    }
...
update_json(base_path + "en.json", admin_pooja_form_en, 'en');
update_json(base_path + "hi.json", admin_pooja_form_hi, 'hi');
update_json(base_path + "mr.json", admin_pooja_form_mr, 'mr');
