            ...
            >
                    ...
                    <div className="p-8 md:p-12">
                        ...
                        <div className="flex flex-col items-center text-center mb-10">
                            ...
                            <h1 className="text-3xl md:text-4xl font-serif font-bold text-slate-900 mb-2">
                                {t('seller_login.title')}
                            </h1>
                            <p className="text-slate-500 max-w-xs mx-auto">
                                {t('seller_login.subtitle')}
                            </p>
                        </div>
                        ...
                        {!showOtpInput ? (
                            <form onSubmit={handleSendOTP} className="space-y-6">
                                <div className="space-y-3">
                                    <Label htmlFor="phone" className="text-slate-700 font-medium ml-1">{t('seller_login.phone_label')}</Label>
                                ...
                                >
                                    {loading ? (
                                        <div className="flex items-center gap-2">
                                            ...
                                            {t('seller_login.checking')}
                                        </div>
                                    ) : (
                                        <div className="flex items-center gap-2">
                                            {t('seller_login.send_otp')}
                            ...
                            <form onSubmit={handleVerifyOTP} className="space-y-6">
                                {devOtp && (
                                    ...
                                    >
                                        <p className="text-slate-600 text-xs font-medium mb-1">{t('seller_login.dev_otp')}</p>
                                        <p className="text-3xl font-serif font-bold text-[#7b4623] tracking-widest">{devOtp}</p>
                                    </motion.div>
                                )}
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center ml-1">
                                        <Label htmlFor="otp" className="text-slate-700 font-medium">{t('seller_login.enter_otp_label')}</Label>
                                        <button
                                            type="button"
                                    ...
                                    <p className="text-xs text-slate-400 text-center">
                                        {t('seller_login.otp_sent_to')} <span className="text-slate-600 font-bold">+91 {phone}</span>
                                    </p>
                                </div>
                                ...
                                >
                                    {loading ? (
                                        <div className="flex items-center gap-2">
                                            <div className="w-5 h-5 border-2 border-white/20 border-t-white rounded-full animate-spin" />
                                            {t('seller_login.verifying')}
                                        </div>
                                    ) : (
                                        <div className="flex items-center gap-2">
                                            {t('seller_login.login_button')}
                ...
                <div className="mt-8 flex items-center justify-center gap-6 opacity-40">
                    <div className="flex items-center gap-2 grayscale brightness-50">
                        <ShieldCheck className="w-4 h-4" />
                        <span className="text-xs font-bold uppercase tracking-widest">{t('seller_login.secure_login')}</span>
                    </div>
                </div>
            </motion.div>
                                ...
                                <div className="p-8">
                                    ...
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <h2 className="text-2xl font-serif font-bold text-slate-900 mb-3">
                                            {t('seller_login.not_registered.title')}
                                        </h2>

                                        <p className="text-slate-500 text-sm leading-relaxed mb-2">
                                            {t('seller_login.not_registered.p1')}
                                        </p>

                                        <p className="text-slate-600 text-sm font-medium mb-6">
                                            {t('seller_login.not_registered.p2')}
                                        </p>
                                        ...
                                        >
                                            {t('seller_login.not_registered.button')}
                                        </button>
                                    </div>
                                </div>
                            </div>
