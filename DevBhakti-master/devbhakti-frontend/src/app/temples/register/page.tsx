...
export default function RegisterTemplePage() {
    ...
    const benefits = [
        {
            title: t('temple_register.benefits_section.benefits.b1.title'),
            desc: t('temple_register.benefits_section.benefits.b1.desc'),
        ...
        {
            title: t('temple_register.benefits_section.benefits.b2.title'),
            desc: t('temple_register.benefits_section.benefits.b2.desc'),
        ...
        {
            title: t('temple_register.benefits_section.benefits.b3.title'),
            desc: t('temple_register.benefits_section.benefits.b3.desc'),
        ...
        {
            title: t('temple_register.benefits_section.benefits.b4.title'),
            desc: t('temple_register.benefits_section.benefits.b4.desc'),
        ...
        {
            title: t('temple_register.benefits_section.benefits.b5.title'),
            desc: t('temple_register.benefits_section.benefits.b5.desc'),
        ...
        {
            title: t('temple_register.benefits_section.benefits.b6.title'),
            desc: t('temple_register.benefits_section.benefits.b6.desc'),
    ...
    const testimonials = [
        {
            name: t('temple_register.testimonials_section.t1.name'),
            role: t('temple_register.testimonials_section.t1.role'),
            content: t('temple_register.testimonials_section.t1.content'),
            avatar: "https://images.unsplash.com/photo-1586348943529-beaae6c28db9?q=80&w=2070&auto=format&fit=crop",
            rating: 5
        },
        {
            name: t('temple_register.testimonials_section.t2.name'),
            role: t('temple_register.testimonials_section.t2.role'),
            content: t('temple_register.testimonials_section.t2.content'),
        ...
        {
            name: t('temple_register.testimonials_section.t3.name'),
            role: t('temple_register.testimonials_section.t3.role'),
            content: t('temple_register.testimonials_section.t3.content'),
    ...
    const stats = [
        { number: "1000+", label: t('temple_register.stats.temples'), icon: Building2 },
        { number: "5M+", label: t('temple_register.stats.devotees'), icon: Users },
        { number: "50K+", label: t('temple_register.stats.rituals'), icon: Calendar },
        { number: "24/7", label: t('temple_register.stats.live_darshan'), icon: Eye }
    ]
                    ...
                    <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-black max-w-3xl mx-auto mb-12 leading-relaxed font-light font-sans">
                                {t('temple_register.hero.description')}
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center">
                                ...
                                >
                                    ...
                                    {t('temple_register.hero.register_button')}
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                            ...
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <h2 className="text-4xl font-bold font-serif text-foreground mb-6">{t('temple_register.intro.title')}</h2>
                                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                                    {t('temple_register.intro.description')}
                                </p>

                                <div className="space-y-4 mb-8">
                                    {[
                                        { icon: CheckCircle2, text: t('temple_register.intro.bullet1') },
                                        { icon: Shield, text: t('temple_register.intro.bullet2') },
                                        { icon: Clock, text: t('temple_register.intro.bullet3') },
                                        { icon: TrendingUp, text: t('temple_register.intro.bullet4') }
                                    ].map((item, i) => (
                                ...
                                >
                                    {t('temple_register.intro.get_started')}
                ...
                <section className="py-24 bg-muted/30 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <motion.div
                            ...
                            className="text-center mb-16"
                        >
                            <h2 className="text-4xl md:text-5xl font-bold font-serif text-foreground mb-4">{t('temple_register.benefits_section.title')}</h2>
                            <div className="w-32 h-1.5 bg-gradient-sacred mx-auto rounded-full"></div>
                        </motion.div>
                ...
                <section className="py-24 bg-background relative overflow-hidden">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <motion.div
                            ...
                            className="text-center mb-16"
                        >
                            <h2 className="text-4xl md:text-5xl font-bold font-serif text-foreground mb-4">{t('temple_register.testimonials_section.title')}</h2>
                            <div className="w-32 h-1.5 bg-gradient-sacred mx-auto rounded-full"></div>
                        </motion.div>
                ...
                <section className="py-24 bg-muted/50 relative overflow-hidden">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <motion.div
                            ...
                            className="text-center mb-16"
                        >
                            <h2 className="text-4xl md:text-5xl font-bold font-serif text-foreground mb-4">{t('temple_register.features_section.title')}</h2>
                            <div className="w-32 h-1.5 bg-gradient-sacred mx-auto rounded-full"></div>
                        </motion.div>

                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                { title: t('temple_register.features_section.features.f1.title'), desc: t('temple_register.features_section.features.f1.desc'), icon: Globe, color: "from-primary to-primary" },
                                { title: t('temple_register.features_section.features.f2.title'), desc: t('temple_register.features_section.features.f2.desc'), icon: donateIcon, isImage: true, color: "from-primary to-primary" },
                                { title: t('temple_register.features_section.features.f3.title'), desc: t('temple_register.features_section.features.f3.desc'), icon: diyaIcon, isImage: true, color: "from-primary to-primary" },
                                { title: t('temple_register.features_section.features.f4.title'), desc: t('temple_register.features_section.features.f4.desc'), icon: offeringIcon, isImage: true, color: "from-primary to-primary" },
                                { title: t('temple_register.features_section.features.f5.title'), desc: t('temple_register.features_section.features.f5.desc'), icon: Smartphone, color: "from-primary to-primary" },
                                { title: t('temple_register.features_section.features.f6.title'), desc: t('temple_register.features_section.features.f6.desc'), icon: LayoutDashboard, color: "from-primary to-primary" }
                            ].map((feature, i) => {
                    ...
                    <div className="max-w-4xl mx-auto text-center px-4 relative z-10 mb-6">
                        ...
                        >
                            ...
                            <h2 className="text-4xl md:text-5xl font-bold font-serif text-primary mb-6">
                                {t('temple_register.cta.title')}
                            </h2>
                            <p className="text-xl text-black mb-10 max-w-2xl mx-auto">
                                {t('temple_register.cta.description')}
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-8">
                                ...
                                >
                                    ...
                                    {t('temple_register.cta.register_now')}
                                </Button>
                            </div>
                            ...
                            <div className="flex justify-center gap-8 text-sm text-black/80">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span>{t('temple_register.cta.free_to_join')}</span>
                                </div>
                                <div className="flex items-center gap-2 text-black">
                                    <CheckCircle2 className="w-5 h-5 text-black" />
                                    <span>{t('temple_register.cta.easy_setup')}</span>
                                </div>
                                <div className="flex items-center gap-2 text-black">
                                    <CheckCircle2 className="w-5 h-5 text-black" />
                                    <span>{t('temple_register.cta.dedicated_support')}</span>
                                </div>
                            </div>
                        </motion.div>
                    </div>
