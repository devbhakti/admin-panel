        ...
        <div className="min-h-screen bg-[#fdf6e9]">
            ...
            <main className="pt-32 pb-20 container mx-auto px-4 text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl font-display font-bold text-[#2a1b01] mb-4">
                        {t('marketplace.order_success.title')}
                    </h1>
                    <h2 className="text-2xl font-display font-semibold text-[#794A05] mb-6">
                        {t('marketplace.order_success.subtitle')}
                    </h2>

                    <p className="text-slate-600 mb-10 text-lg leading-relaxed">
                        {t('marketplace.order_success.description')}
                    </p>
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                    <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-[#794A05]/10">
                        ...
                        <p className="text-xs font-bold uppercase tracking-widest text-[#794A05]/60 mb-1">
                            {t('marketplace.order_success.authentic')}
                        </p>
                        <p className="text-sm font-semibold text-[#2a1b01]">
                            {t('marketplace.order_success.temple_blessed')}
                        </p>
                    </div>
                    <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-[#794A05]/10">
                        <CheckCircle2 className="w-8 h-8 text-[#794A05] mx-auto mb-3" />
                        <p className="text-xs font-bold uppercase tracking-widest text-[#794A05]/60 mb-1">
                            {t('marketplace.order_success.quality')}
                        </p>
                        <p className="text-sm font-semibold text-[#2a1b01]">
                            {t('marketplace.order_success.handpicked')}
                        </p>
                    </div>
                    <div className="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-[#794A05]/10">
                        <ArrowRight className="w-8 h-8 text-[#794A05] mx-auto mb-3" />
                        <p className="text-xs font-bold uppercase tracking-widest text-[#794A05]/60 mb-1">
                            {t('marketplace.order_success.fast_delivery')}
                        </p>
                        <p className="text-sm font-semibold text-[#2a1b01]">
                            {t('marketplace.order_success.pan_india')}
                        </p>
                    </div>
                </div>
            </main>
