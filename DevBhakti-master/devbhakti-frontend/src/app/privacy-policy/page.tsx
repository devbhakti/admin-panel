            ...
            <section className="py-20 container mx-auto px-4">
                <div className="max-w-5xl mx-auto grid gap-8">
                    ...
                    >
                        ...
                        <div className="flex-grow">
                            <h3 className="text-2xl font-serif font-bold mb-4 text-primary">{t('privacy.grievance.title')}</h3>
                            <p className="text-lg text-foreground/80 leading-relaxed mb-4">{t('privacy.grievance.p1')}</p>
                            <div className="bg-white p-6 rounded-2xl border border-primary/20 space-y-2">
                                <p className="text-xl font-bold text-foreground">{t('privacy.grievance.officer_name') || "Siddharth Pednekar"}</p>
                                <p className="text-foreground/70">{t('privacy.grievance.designation') || "Grievance Officer"}</p>
                                <p className="text-foreground/70">{t('privacy.grievance.company')}</p>
                                <p className="text-primary font-bold">{t('privacy.grievance.email')}</p>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="flex-grow">
                            ...
                            <p className="text-lg text-foreground/80 leading-relaxed mt-2"><span className="font-semibold">{t('privacy.governing_law.jurisdiction')}</span></p>
                        </div>
                    </motion.div>
                </div>
            </section>
