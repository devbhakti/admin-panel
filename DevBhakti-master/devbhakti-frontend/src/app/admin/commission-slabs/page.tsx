        ...
        <div className="p-4 sm:p-6 max-w-7xl mx-auto">
            ...
            <div className="flex border-b border-gray-200 mb-6 overflow-x-auto no-scrollbar">
                <button
                    ...
                    className={`whitespace-nowrap px-6 py-3 font-semibold text-sm transition-all duration-200 border-b-2 ${activeCategory === 'MARKETPLACE'
                ...
                <button
                    ...
                    className={`whitespace-nowrap px-6 py-3 font-semibold text-sm transition-all duration-200 border-b-2 ${activeCategory === 'POOJA'
                        ? 'border-orange-600 text-orange-600'
                        : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                        }`}
                >
            ...
            {/* Create Form */}
            {isCreating && (
                <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 mb-6 border-2 border-orange-500">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-4">
                        ...
                        <button
                            onClick={cancelEdit}
                            className="flex items-center justify-center gap-2 bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600 w-full sm:w-auto"
                        >
                            <X size={18} />
                            Cancel
                        </button>
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200">
                {/* overflow-x-auto handles responsiveness for the table on small screens */}
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {slabs.map((slab) => (
                                <tr key={slab.id} className={editingId === slab.id ? 'bg-orange-50' : 'hover:bg-gray-50'}>
                                    {editingId === slab.id ? (
                                        <>
                                            <td className="px-4 sm:px-6 py-4">
                                                <div className="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
                                                    <input
                                                        ...
                                                        value={formData.minAmount}
                                                        onChange={(e) => setFormData({ ...formData, minAmount: e.target.value })}
                                                        className="w-full sm:w-20 px-2 py-1 border rounded focus:ring-2 focus:ring-orange-500 outline-none"
                                                    />
                ...
                {slabs.length === 0 && !loading && (
                    <div className="text-center py-12 text-gray-500 px-4">
                        <p className="text-lg font-medium">No commission slabs found</p>
