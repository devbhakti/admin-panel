        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold text-foreground mb-4">
              ...
              <span className="text-gradient-sacred">{t('landing.cta.title2')}</span>
            </h2>
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className={`text-xl font-serif font-bold mb-3 ${card.cardType === "primary"
                    ...
                    {getLocalized(card, 'title', language)}
                  </h3>
                  <ul className="space-y-3 mb-6">
                    {getLocalizedArray(card, 'points', language).map((point, pointIndex) => (
                      <li
                        key={pointIndex}
                  ...
                  >
                    <Link href={card.buttonLink}>
                      {getLocalized(card, 'buttonText', language)}
                    </Link>
                  </Button>
                </div>
              </motion.div>
