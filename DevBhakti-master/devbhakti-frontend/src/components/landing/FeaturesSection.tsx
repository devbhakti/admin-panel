  ...
  const localizedFeatures = [
    {
      ...
      icon: diyaIcon,
      isImage: true,
      title: t('landing.features.items.pooja_booking.title'),
      description: t('landing.features.items.pooja_booking.description'),
      image: poojaBooking,
    ...
    },
    {
      ...
      icon: offeringIcon,
      isImage: true,
      title: t('landing.features.items.live_darshan.title'),
      description: t('landing.features.items.live_darshan.description'),
      image: liveDarshan,
      accent: "text-red-600",
    },
    {
      id: "devotional_products",
      icon: pujaIcon,
      isImage: true,
      title: t('landing.features.items.devotional_products.title'),
      description: t('landing.features.items.devotional_products.description'),
    ...
    },
    {
      ...
      icon: donateIcon,
      isImage: true,
      title: t('landing.features.items.easy_donation.title'),
      description: t('landing.features.items.easy_donation.description'),
      image: easyDonation,
    ...
    },
    {
      ...
      icon: templeIcon,
      isImage: true,
      title: t('landing.features.items.temple_discovery.title'),
      description: t('landing.features.items.temple_discovery.description'),
    ...
    },
    {
      ...
      icon: prasadIcon,
      isImage: true,
      title: t('landing.features.items.prasad_delivery.title'),
      description: t('landing.features.items.prasad_delivery.description'),
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {displayFeatures.map((feature, index) => (
            <motion.div
              key={feature.id || feature._id || `feature-${index}`}
              initial={{
                opacity: 0,
                y: 30,
              }}
            ...
            >
              ...
              <div className="absolute inset-0">
                <Image
                  ...
                  alt={dynamicFeatures.length > 0 ? getLocalized(feature, 'title', language) : feature.title}
                  fill
              ...
              <div className="absolute inset-0 p-8 flex flex-col justify-end">
                ...
                <div className="absolute top-6 right-6 bg-white/10 backdrop-blur-md border border-white/20 p-3 rounded-2xl group-hover:bg-[#845028] group-hover:border-[#845028] transition-colors duration-300">
                  {dynamicFeatures.length > 0 ? (
                    ...
                    <Image src={feature.icon as any} alt={dynamicFeatures.length > 0 ? getLocalized(feature, 'title', language) : feature.title} width={24} height={24} className="w-6 h-6 object-contain" />
                  ) : (
                    (() => {
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-serif font-bold text-white drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] mb-2 group-hover:text-orange-100 transition-colors">
                    {dynamicFeatures.length > 0 ? getLocalized(feature, 'title', language) : feature.title}{" "}
                  </h3>
                  <p className="text-white text-sm drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)]">
                    {dynamicFeatures.length > 0 ? getLocalized(feature, 'description', language) : feature.description}{" "}
                  </p>
                </div>
              </div>
            </motion.div>
