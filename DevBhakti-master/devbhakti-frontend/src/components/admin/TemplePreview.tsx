                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="border-none shadow-md">
                            <CardContent className="p-6">
                                <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                                    <div>
                                        <Badge variant="secondary" className="mb-2 bg-primary/10 text-primary border-none">
                                            {temple.category || t("temple_preview.default_category")}
                                        </Badge>
                                    ...
                                    <div className="flex items-center gap-1 bg-amber-50 px-3 py-1.5 rounded-full border border-amber-100">
                                        ...
                                        <span className="text-slate-500 text-xs">
                                            ({(temple.reviewsCount || 0).toLocaleString()}{t("temple_preview.reviews_count")})
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        <h3 className="font-semibold text-slate-900 mb-1">{t("temple_preview.about_title")}</h3>
                                        <p className="text-sm text-slate-600 leading-relaxed">
                                            {temple.description || t("temple_preview.no_description")}
                                        </p>
                                    </div>
                                    {temple.history && (
                                        <div>
                                            <h3 className="font-semibold text-slate-900 mb-1">{t("temple_preview.history_title")}</h3>
                                            <p className="text-sm text-slate-600 leading-relaxed">
                                                {temple.history}
                                            </p>
                                        </div>
                        ...
                        <Tabs defaultValue="poojas" className="w-full">
                            <TabsList className="w-full justify-start bg-slate-100 p-1 rounded-lg">
                                <TabsTrigger value="poojas" className="rounded-md data-[state=active]:bg-white data-[state=active]:shadow-sm">{t("temple_preview.tabs.poojas")}</TabsTrigger>
                                <TabsTrigger value="events" className="rounded-md data-[state=active]:bg-white data-[state=active]:shadow-sm">{t("temple_preview.tabs.events")}</TabsTrigger>
                            </TabsList>
                            ...
                            <CardContent className="p-6 space-y-4">
                                <div className="space-y-4 pt-2">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-xs text-slate-500">{t("temple_preview.managed_by")}</p>
                                    ...
                                    {temple.mapUrl && (
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-xs text-slate-500">{t("temple_preview.map_location")}</p>
                                                <a
                                                    href={temple.mapUrl}
                                                    target="_blank"
                                                ...
                                                >
                                                    {t("temple_preview.view_google_maps")}
                                                </a>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {temple.gallery && temple.gallery.length > 0 && (
                                        <div className="pt-4 border-t border-slate-100">
                                            <p className="text-xs font-semibold text-slate-900 mb-3">{t("temple_preview.gallery_preview")}</p>
