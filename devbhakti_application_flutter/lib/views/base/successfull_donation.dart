...
class SuccessfullDonation extends StatefulWidget {
  const SuccessfullDonation({super.key});

  @override
  State<SuccessfullDonation> createState() => _SuccessfullDonationState();
}

class _SuccessfullDonationState extends State<SuccessfullDonation>
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text(
                  "Your generous contribution has been received. May you be blessed with peace and prosperity.",
                  style: TextStyle(
                    fontSize: 14,
